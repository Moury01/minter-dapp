...
const welcome_h1 = "Welcome to the Alienies NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Alienies NFT Project is a decentralized, open-source project that aims to help in charity work as the community also grows';
